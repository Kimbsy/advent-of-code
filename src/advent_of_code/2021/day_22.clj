...
(defn valid-cuboid?
  [c]
  (every? (partial apply <=) c))

(defn subtract-cube-all
  [[[xl1 xh1] [yl1 yh1] [zl1 zh1]]
   [[xl2 xh2] [yl2 yh2] [zl2 zh2]]]
  (->> [[[xl1 xh1] [yl1 yh1] [zl1 (min zh1 (dec zl2))]] ; bottom
        [[xl1 xh1] [yl1 yh1] [(max zl1 (inc zh2)) zh1]] ; top
        [[xl1 xh1] [yl1 (min yh1 (dec yl2))] [(max zl1 zl2) (min zh1 zh2)]] ; front
        [[xl1 xh1] [(max yl1 (inc yh2)) yh1] [(max zl1 zl2) (min zh1 zh2)]] ; back
        [[xl1 (min xh1 (dec xl2))] [(max yl1 yl2) (min yh1 yh2)] [(max zl1 zl2) (min zh1 zh2)]] ; left
        [[(max xl1 (inc xh2)) xh1] [(max yl1 yl2) (min yh1 yh2)] [(max zl1 zl2) (min zh1 zh2)]] ; right
        ]
       (filter valid-cuboid?)))
...
(defn turn-off
  ...
  (mapcat (fn [existing-cube]
            (subtract-cube-all existing-cube c))
          cubes))
...
;; refactoring check
;; (= [(part-1) (part-2)] [644257 1235484513229032])
